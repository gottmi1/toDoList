...
function saveToDos():void { // 로컬 저장소에 toDos에 업데이트 된 값을 세팅해주는 역할을 함
...
function paintToDo(newTodo:any):void { // li와 span등을 만들어 DOM에 추가해주는 역할을 한다. 
